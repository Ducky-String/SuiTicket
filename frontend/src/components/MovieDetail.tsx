        ...
        <div className="grid grid-cols-12 gap-0 md:gap-8">
          ...
          <div className="col-span-12 md:col-span-9 p-6 md:p-10 md:pl-0 space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-lg italic">"Trải nghiệm điện ảnh đỉnh cao trên nền tảng Web3"</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 leading-relaxed text-lg text-justify md:pr-10">
                {movie.description}
                <br/><br/>
                Sở hữu ngay vé NFT giới hạn để nhận được những đặc quyền duy nhất chỉ dành cho chủ sở hữu trên Sui Blockchain. Mỗi tấm vé là một tài sản kỹ thuật số độc bản, minh chứng cho sự đam mê điện ảnh của bạn.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 pt-6">
              <button 
                onClick={() => onBuy(movie)}
                className="w-full sm:w-auto px-12 py-4 bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-500 hover:to-emerald-500 text-white font-black rounded-2xl shadow-xl shadow-blue-500/20 transition-all hover:scale-[1.02] active:scale-95 uppercase tracking-widest flex items-center justify-center gap-3"
              >
